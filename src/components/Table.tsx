...
const Table = ({ employees, handleDelete, handleEdit }: TableTypes ) => {
  return (
    <table className="my-2 w-full border-separate border-spacing-y-3 border-spacing-x-0">
      ...
      <tbody className="text-center px-5  [&>*:nth-child(even)]:bg-slate-800">
        {employees.map((employee) => (
          <tr
            className="transition-all delay-100 duration-300 h-10 hover:bg-slate-800 group relative"
